...
set val(y)              800 
set val(ifqlen)         50                	;# Maximum Queue NodeNum in Interface Queue
set val(seed)           0.0
...
#set namtracefd  [open chain.nam w]               
...
$node_(1) set X_ 50
$node_(1) set Y_ 150
#set cnttmp [expr $val(stop) -0.001]
for {set i 2; set j 1} {$i < [expr $val(nn) - 2]} {incr i; incr j} {
...
create_tcp_connection 0 0 [expr $val(nn)-2]
create_tcp_connection 1 1 [expr $val(nn)-1]
...
if {$Program <= 1} {
# Call the mac procedure to print the average queue NodeNum
