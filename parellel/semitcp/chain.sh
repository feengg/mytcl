...
while [ $i -lt 21 ]; do
	...
	../../../semitcp/semitcp chain.tcl 0 $i 300 9 1 1 10 1 >> q_length.txt
...
#	echo --- Hop Node Number:$i ---	>> HopsResultInst.txt
	...
	gawk -f ../../trace2stats_v05b/avgStatsForTcp.awk src=1 dst=$endnode2 flow=1 pkt=512 chain.tr >> HopsResultAvg.txt
