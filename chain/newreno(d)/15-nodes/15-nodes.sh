...
../../../../tcpap/tcpap ../chain.tcl 3 $i 300 7 1 >> q_length.txt
let j=$i-1
...
gawk -f ../../../trace2stats_v05b/brief.awk flag="retransmit_backward_ack" q_length.txt > retransmit_backward_ack
gawk -f ../../../trace2stats_v05b/brief.awk flag="retransmit_forward_data" q_length.txt > retransmit_forward_data
...
./RetransmitRTS.sh
./RetransmitDATA.sh
./retransmit_backward_ack.sh
./retransmit_forward_data.sh
./RTS_droped.sh
./DATA_droped.sh
./RTS_CTS_rate.sh
./all_success_rate.sh
